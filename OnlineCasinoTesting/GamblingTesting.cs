...
namespace OnlineCasinoTesting
{
    public class GamblingTesting
    {
        ...
        [Theory]
        [InlineData(2.0, "1")]
        public void playSlotTestDouble(double bet, string username)
        {
            ...
            var res = gambling.playSlot(bet, username);
            Assert.Equal("771", res);
        }

        [Theory]
        [InlineData(2.0, "1")]
        public void playSlotTestTriple(double bet, string username)
        {
        ...
        [Theory]
        [InlineData(2.0, "1")]
        public void playSlotTestNoWin(double bet, string username)
        {
        ...
        //[Theory]
        //[InlineData(2.0, "1")]
        //public void playSlotTestJackPot(double bet, string username)
        //{
        //    string gamblerAmountList = "[{\"betAmount\":2.0,\"payout\":0.0}]";
        //    string fRAmountlList = "[{\"betAmount\":2.0,\"payout\":0.0}]";
        //    string fileSimulation1 = "Users\\" + username + "\\" + DateTime.Now.ToString("yyMM");
